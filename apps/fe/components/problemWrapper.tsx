...
export default function ProblemWrapper({
    ...
    return (
        <>
            <Nav />
            <div className="flex flex-col bg-zinc-950 overflow-hidden min-h-screen pt-[70px]">
                {/* Breadcrumb */}
                <div className="border-b border-zinc-900 px-6 h-11 flex items-center gap-3 shrink-0 font-mono text-xs text-zinc-500">
                    <Link
                        href="/problems"
                    ...
                    <span className={`font-mono text-[10px] font-bold px-3 py-0.5 rounded-sm ${ds.chip}`}>
                        {ds.label}
                    </span>

                    <div className="ml-auto flex gap-5 text-[11px] text-zinc-600">
