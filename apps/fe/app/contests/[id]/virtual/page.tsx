...
const DIFF_STYLES: Record<string, string> = {
    EASY: "text-[#4ade80] bg-[#0d2e16] border-[#1a5c2d]",
    MEDIUM: "text-[#ffd700] bg-[#1a1a0d] border-[#4a4a1a]",
    HARD: "text-[#ff4d4d] bg-[#2d0d0d] border-[#5c1a1a]",
};
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0a0a0a] pt-[70px]">
                ...
                <div className="fixed top-[50px] left-0 right-0 z-50 bg-[#111] border-b border-purple-900 px-6 py-2">
                    <div className="max-w-6xl mx-auto flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <span
                                className={`font-mono text-lg font-bold ${timeLeft < 300000 ? "text-red-400" : timeLeft < 1800000 ? "text-yellow-400" : "text-green-400"
                                    }`}
                            >
                                {formatTime(timeLeft)}
                            </span>
                ...
                {/* Problems list */}
                <div className="max-w-4xl mx-auto px-6 py-8 mt-10">
                    <div className="bg-[#111] border border-[#1e1e1e] rounded-lg overflow-hidden">
                        ...
                        <div className="divide-y divide-[#1e1e1e]">
                            {contest.problems.map((p, i) => {
                                const dsClass = DIFF_STYLES[p.problem.difficulty] ?? DIFF_STYLES.MEDIUM;
                                return (
                                    <Link
                                        key={p.id}
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span
                                                className={`font-[family-name:var(--font-mono)] text-[10px] font-bold px-2 py-0.5 rounded-sm border ${dsClass}`}
                                            >
