                    ...
                    <div className="flex items-start justify-between mb-8">
                        ...
                        {contest.isPractice && contest.status === "past" && registered ? (
                            ...
                            <button
                                ...
                                className={`px-6 py-2.5 rounded font-mono text-sm font-bold transition-colors ${registered
                                    ...
                                    {contest.problems.length === 0 ? (
                                        ...
                                        contest.problems.map((p, i) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span
                                                        className={`font-mono text-[10px] px-2 py-0.5 rounded ${p.problem.difficulty === "EASY"
                                    ...
                                    {entries.length === 0 ? (
                                        ...
                                        entries.slice(0, 20).map((entry) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <span
                                                        className={`font-mono text-xs font-bold w-6 ${entry.rank <= 3
                                                                ? "text-amber-400"
                                                                : "text-zinc-500"
                                                            }`}
                                                    >
